...
rvc_models_dir = "/content/drive/MyDrive/rvc_models"
...
def voice_change(
    ...
    hubert_model = load_hubert(
        device, config.is_half, "/content/AICoverGen/rvc_models/hubert_base.pt"
    )
...
def find_full_path(song_title, isMan):
    if isMan:
        isMan_var = "man"
    else:
        isMan_var = "woman"
    base_path = f"/content/drive/MyDrive/guide_collection/{isMan_var}"
    song_guide_pathes = []
    search_path = os.path.join(base_path, song_title)
    ...
    return song_guide_pathes


# def find_vocal_files(input_song_titles):
#     base_path = "/content/drive/MyDrive/guide_collection/man"
#     vocal_files = []
